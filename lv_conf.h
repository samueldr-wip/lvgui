...
#define LV_DPI              (mn_hal_default_dpi)     /*[px]*/
...
// Ugh, this is a hack since lv_font_t is not available here
// to do the `extern` declaration.
// This is why we're hiding the void* under the rug.
// This way we can fix the type along the way when possible.
typedef void* mn_hal_default_font_t;
extern mn_hal_default_font_t mn_hal_default_font;
#define LV_FONT_DEFAULT       ((lv_font_t*) mn_hal_default_font) 
...
#define LV_TXT_LINE_BREAK_LONG_LEN          24
