...
#if LV_COLOR_DEPTH == 1
#error THEME_NIXOS needs colours
#endif
...
#define    COLOR_BLUE_DARKER  lv_color_hex(0x27385D)
#define    COLOR_BLUE_DARK2   lv_color_hex(0x405D99)
#define    COLOR_BLUE_DARK    lv_color_hex(0x5277C3)
#define    COLOR_BLUE         lv_color_hex(0x6586C8)
#define    COLOR_BLUE_LIGHT   lv_color_hex(0x7EBAE4)
#define    COLOR_BLUE_LIGHTER lv_color_hex(0xF2F8FD)
#define    COLOR_GREEN        lv_color_hex(0x6AD541)
...
#define BASE_HUE 220
#define BUTTON_HUE 205

#define DEF_COLOR_TEXT COLOR_WHITE
#define DEF_COLOR_TEXT_SECONDARY lv_color_hex(0xcce3f5)

// This shadow color is cheating... a lot...
#define    DEF_SHADOW_COLOR   lv_color_hex(0x3E5A90)
...
static void basic_init(void)
{
    ...
    bg.body.main_color = COLOR_BLUE_DARK;
